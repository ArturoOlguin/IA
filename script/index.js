...
const firstLevelValidation = ([nodosPadreNumber, nodosHijoNumber, nodoMetaNumber, amplitudNumber, nivelNumber]) => {
    const validator = (amplitudNumber > 0 ? setSuccessFor(amplitud) : setErrorFor(amplitud, 'Debe ingresar un numero positivo')) &&
        (nivelNumber > 1 ? setSuccessFor(nivel) : setErrorFor(nivel, 'Debe ingresar un numero positivo')) &&
...
//Verifica que el valor de Nodo Padre  sea menor que Hijos
...
//Verifica los Maximos y minimos posibles los nodos padre e hijo
...
//Verifica que el nodo meta se encuentre dentro rango de valores
...
// En caso de erro envia el msg del error 
...
// si todo fue correcto se guardan los elementos con localStorage
